...
export const CARD_CATALOG: Readonly<Record<string, DingCard>> = {
  ...
  dismantle: {
    ...
    symbol: "⌁",
    tone: "#a97752",
    description: "出牌阶段对一名其他角色使用，随机弃置其手牌、装备或判定区里的一张牌。",
  },
  snatch: {
    id: "snatch",
    name: "牵袭",
    ...
    symbol: "↯",
    tone: "#8d4b63",
    description: "出牌阶段对距离 1 的一名其他角色使用，随机获得其手牌、装备或判定区里的一张牌。",
  },
  nullify: {
    id: "nullify",
    name: "无懈可击",
  ...
  probe: {
    ...
    symbol: "窥",
    tone: "#6b5b8e",
    description: "出牌阶段对一名身份未公开的其他角色使用。猜测其身份：猜对则其身份公开，你摸两张牌；猜错则你随机弃置一张手牌。",
  },
  "delay-play": {
    id: "delay-play",
    name: "断锋",
  ...
  armor: {
    ...
    symbol: "甲",
    tone: "#5b6a78",
    description: "防具：每回合你首次受到伤害时，该伤害 -1。",
  },
  longblade: {
    id: "longblade",
    name: "长锋",
